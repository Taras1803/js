...
button.onclick =  function insertmessage() {
    ...
    var nick = document.getElementById('autor').value;
    jsonPost("http://casino.tarasvrudenko.php.a-level.com.ua/chat2/server.php", {func: 'addMessage', nick: nick , message: message})
